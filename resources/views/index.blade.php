...
<head>
  ...
  .nav-setting-open {
  display: none !important; /* Hide the icon by default */
}

/* Styles for mobile and tablet view */
@media only screen and (max-width: 768px) {
  .nav-setting-open {
    display: inline-block !important; /* Display the icon on mobile and tablet screens */
  }
}
...
<body>
   ...
   @include('layouts.sidebar')
    <!-- End Left menu area -->
    <!-- Start Welcome area -->
    <div class="all-content-wrapper topbar">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                        <div class="header-right-info">
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item nav-setting-open"><a class="mobile-menu" href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="educate-icon educate-menu"></i></a>
...
document.addEventListener('DOMContentLoaded', function () {
  const toggleSidebarBtn = document.querySelector('.mobile-menu');
