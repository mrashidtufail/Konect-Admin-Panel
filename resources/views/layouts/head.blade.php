...
<!-- favicon
    ============================================ -->
<link rel="shortcut icon" type="image/x-icon" href="theme/class="educate-icon educate-menu"img/favicon.ico">
<!-- Google Fonts
    ============================================ -->
...
<link rel="stylesheet" href="{{ asset('theme/Icons/v1.4.0/iconpicker-1.4.0.css') }}">
...
<link rel="stylesheet" href="{{ asset('theme/Icons/feathericon.min.css') }}">
...
<link rel="stylesheet" href="{{ asset('theme/custom_style.css') }}">
